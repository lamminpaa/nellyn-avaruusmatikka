...
<body>
    <div id="game-container">
        <header>
            ...
            <div id="defense-points">🛡️ Puolustus: <span id="defense-points-value">0</span></div>
        ...
        <div id="game-panel">
            ...
            <div id="defense-controls">
                <h3>🛡️ Planeetan puolustus</h3>
                <div id="defense-buttons">
                    <button id="build-turret" class="defense-btn">Rakenna Torni (5 🛡️)</button>
                    <button id="build-drone" class="defense-btn">Rakenna Drone (3 🛡️)</button>
                    <button id="upgrade-shields" class="defense-btn">Päivitä Kilvet (7 🛡️)</button>
                </div>
                <div id="defense-status">
                    <div>Tornit: <span id="turret-count">0</span></div>
                    <div>Dronit: <span id="drone-count">0</span></div>
                    <div>Kilvet: <span id="shield-level">0</span></div>
                </div>
            </div>
